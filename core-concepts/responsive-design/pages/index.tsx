  ...
  return (
    <>
      ...
      <main className="flex items-center justify-center p-8 w-screen h-screen">
        <div className="max-w-md sm:max-w-2xl mx-auto bg-white rounded-lg shadow-xl overflow-hidden ring-1 ring-slate-900/5">
          <div className="flex flex-col min-[640px]:flex-row">
            <div className="tablet:shrink-0">
              <Image className="w-full sm:w-[193px] h-[200px] object-cover object-bottom sm:object-center"
                src={imageUrl} priority width={202} height={192} alt="Modern building architecture" /> </div>
            <div className="p-6 2xl:p-8 space-y-2">
              <div className="text-sm text-indigo-600 font-medium leading-6">Company retreats</div>
